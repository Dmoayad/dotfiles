...
colors.blue 									= "#7aa2f7"
colors.magenta 									= "#ad8ee6"
colors.cyan 									= "#449dab"
colors.white 									= "#787c99"
-- Bright colors
colors.brightblack 								= "#444b6a"
colors.brightred 								= "#ff7a93"
colors.brightgreen 								= "#b9f27c"
colors.brightyellow 							= "#ff9e64"
colors.brightblue 								= "#7da6ff"
colors.brightmagenta 							= "#bb9af7"
colors.brightcyan 								= "#0db9d7"
colors.brightwhite 								= "#acb0d0"
-- Transparent
...
theme.awesome_icon = theme_assets.awesome_icon(
    theme.menu_height, colors.magenta, colors.background
)
